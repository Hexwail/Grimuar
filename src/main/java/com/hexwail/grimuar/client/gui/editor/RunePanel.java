...
public class RunePanel extends Widget {
    ...
    // Додати методи для додавання/видалення рун, прокрутки, вибору тощо
    ...
    // TODO: обробка кліків, виділення, прокрутки

    // Вкладений клас або окремий клас Rune (можна винести в окремий файл)
